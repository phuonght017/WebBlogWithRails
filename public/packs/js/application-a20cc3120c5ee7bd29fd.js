...
document.getElementById("btnShow").addEventListener("click", function () {
  document.getElementById("showCmt").innerHTML = "HelloWord";
}); // const divShow = document.querySelector('#show-cmt');
// const buttonShow = document.querySelector('.count-cmt').addEventListener("click", function() {
//     console.log("HELLO")
//     divShow.innerHTML ="<%= render @post.comments%>"
// })
...
/******/ });
//# sourceMappingURL=application-a20cc3120c5ee7bd29fd.js.map